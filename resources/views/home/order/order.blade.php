								...
								<div class="address-left">
									<div class="user DefaultAddr">
										...
										<span class="buy-address-detail">   
                   						<span class="buy-user">{{ $v->person }} </span>
												...
												<li class="td td-item">
													...
													<div class="item-info">
														<div class="item-basic-info">
															<a href="#" class="item-title J_MakePoint" data-point="tbcart.8.11">{{ $v->tname }}</a>
														</div>
													</div>
												</li>
												<!-- <li class="td td-info">
								   ...
								   <span class="province">湖北</span>省
									...
									<div id="holyshit269" class="submitOrder">
										<div class="go-btn-wrap">
											<a id="J_Go" href="/close" class="btn-go" tabindex="0" title="点击此按钮，提交订单">提交订单</a>
										</div>
									</div>
									<div class="clear"></div>
								</div>
